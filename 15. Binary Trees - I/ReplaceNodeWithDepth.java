...
public class Solution{
     public static void changeToDepthTree(BinaryTreeNode<Integer> root) {
        changeToDepthTreeSolution(root);
        inorder(root);
    }

    static int depth = 0;
    public static void changeToDepthTreeSolution(BinaryTreeNode<Integer> root){
        if (root == null){
            return;
        }
        else{
        ...
        changeToDepthTreeSolution(root.left);
        changeToDepthTreeSolution(root.right);
            depth--;
    }
