...
public class Solution {
	...
	public static boolean isNodePresent(BinaryTreeNode<Integer> root, int x) {
        ...
        boolean leftIsNodePresent = isNodePresent(root.left, x);
        boolean rightIsNodePresent = isNodePresent(root.right, x);
        
    	if(leftIsNodePresent == true){
            return true;
        }
        else if(rightIsNodePresent == true){
            return true;
        }
        return false;
	}
